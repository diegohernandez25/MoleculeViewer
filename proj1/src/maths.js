...
function getAngle(point1,point2)
{
        ...
        //   return 0;
        tmp+= Math.atan((point2[1]-point1[1])/(point2[0]-point1[0])) * 180/Math.PI;
        if(isNaN(tmp)){
            return 0;
        }
        return tmp;
}
function getAngleOrigin(point1,point2)
{
  var angleYY = getAngle([point1[2], point1[0]],[point2[2], point2[0]]);
  matRot = rotationYYMatrix( 90 - angleYY );
  point1.push(0.0);
  point2.push(0.0);
  point1 = multiplyPointByMatrix(matRot, point1);
  point2 = multiplyPointByMatrix(matRot, point2);
  return -getAngle([point1[0],point1[1]],[point2[0],point2[1]]);
}
